  ...
  <aside id="sidebar" class="sidebar-transition fixed lg:static z-40 -translate-x-full lg:translate-x-0 w-[240px] min-h-screen bg-[#1E3A8A] flex flex-col justify-between">
    <div>
      ...
      <nav class="mt-2 px-3 space-y-1">
        <a href="http://127.0.0.1:8000/customer-service/dashboard" class="flex items-center gap-3 px-4 py-3 rounded-xl text-blue-100 hover:bg-white/10 transition-colors">
        ...
        <div>
          <div class="flex items-center rounded-xl bg-white/15 text-white overflow-hidden">
            <a href="{{ route('communication.index') }}" class="flex-1 flex items-center gap-3 px-4 py-3">
              <i data-lucide="message-square" class="w-5 h-5"></i>
              <span class="font-semibold text-sm">Communication History</span>
            </a>
            <button id="commHistoryToggle" type="button" class="flex items-center gap-2 pr-4 py-3 pl-2">
              ...
              <i data-lucide="chevron-down" id="commHistoryChevron" class="w-4 h-4 transition-transform"></i>
            </button>
          </div>

          <div id="commHistorySubmenu" class="mt-1 pl-4 space-y-1 hidden">
            <a href="{{ route('dashboard.history') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-blue-100 hover:bg-white/10 transition-colors text-sm">
