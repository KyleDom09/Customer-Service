<aside class="w-64 bg-navy flex flex-col min-h-screen">
    ...
    <nav class="flex-1 px-4 space-y-2">
        ...
        class="flex items-center justify-between px-4 py-3.5 rounded-lg transition
            ...
            <div class="flex items-center gap-3.5">
                <svg class="w-5 h-5 {{ request()->is('customer-service/dashboard') || request()->is('customer-service/agents*') || request()->is('customer-service/logs*') ? 'text-green-400' : '' }}" fill="currentColor" viewBox="0 0 24 24">
        ...
        {{-- Ticket Management --}}
        <a href="#"
        class="flex items-center gap-3.5 px-4 py-3.5 rounded-lg transition
                {{ request()->is('tickets*')
                        ? 'bg-white/5 text-white ring-1 ring-green-400/40 shadow-[0_0_10px_rgba(74,222,128,0.15)]'
                        : 'text-blue-200 hover:bg-navy-dark hover:text-white' }}">
        ...
        class="flex items-center gap-3.5 px-4 py-3.5 rounded-lg transition
            ...
            <span class="font-medium whitespace-nowrap text-[15px]">Communication History</span>
        </a>
    ...
    <div class="p-4">
        <div class="flex items-center gap-3 bg-navy-dark/60 rounded-lg px-4 py-3.5">
